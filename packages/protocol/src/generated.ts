...
export const PROTOCOL_SCHEMA_SHA256 = "1d26cfa14cc1d0d7e7f246154754ae30e002f99843de5600045a56768f614220" as const
...
export const OPERATION_MIN_MINOR = {"commands.bind":6,"settings.list":8,"settings.set":8,"settings.remove":8,"skills.list":8,"plugins.list":8,"plugins.inspect":8,"plugins.validate":8,"plugins.install":8,"plugins.update":8,"plugins.set_enabled":8,"plugins.remove":8,"agents.list":8,"mcp.status":8,"goal.inspect":8,"goal.request":8,"goal.mutate":8} as const
export const CONTROLLED_OPERATIONS = ["run.start","run.cancel","context.compact","config.preview","config.commit","settings.set","settings.remove","threads.undo","threads.redo","skills.set_enabled","skills.install","skills.update","skills.remove","plugins.install","plugins.update","plugins.set_enabled","plugins.remove","mcp.add","mcp.remove","goal.request","goal.mutate"] as const
