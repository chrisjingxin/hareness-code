...
export const PROTOCOL_SCHEMA_SHA256 = "41df1a3ec501134b285b36d9e3c10ba3ff56f226e1ef01b08b2b6de61ce82340" as const
...
export const EVENT_TYPES = ["run.started","run.progress","skill.loaded","content.delta","reasoning.summary","tool.started","tool.delta","tool.completed","context.updated","interaction.resolved","run.completed","run.cancelled","run.failed"] as const
...
export type ReasoningSummaryPayload = { "text": string }
...
export type AgentEvent =
  ...
  | AgentEventOf<"reasoning.summary", ReasoningSummaryPayload>
