/**
 * Ant Design `CommentOutlined` 的内联 SVG 源码。
 * 来源：`@ant-design/icons-svg` 4.4.2 `svg/outlined/comment.svg`（MIT License，
 * Copyright (c) 2018 Ant Financial，https://github.com/ant-design/ant-design-icons）。
 * 按用户要求内联源码、不引入图标包依赖；fill 制 1024 网格，颜色由 currentColor 继承。
 */
/** @jsxImportSource react */

/** Ant Design 对话气泡图标；size 为像素边长，默认 18 与侧栏图标槽位一致。 */
export function CommentOutlined({ size = 18 }: { size?: number }): React.ReactElement {
  return (
    <svg
