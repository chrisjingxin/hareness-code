...
import { assertEventEnvelope, assertInitializeParams, assertInteractionRequest } from "@za38/protocol"

type Fixture = { kind: "initialize" | "event" | "request"; value: unknown }
...
function validate(fixture: Fixture): void {
  ...
  else assertInteractionRequest(fixture.value)
}
