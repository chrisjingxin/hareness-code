...
- Name: smoke.spec.ts >> 空首页首条消息：发送、回显、代码高亮、草稿清空、Thread 侧栏出现
- Location: tests/e2e/smoke.spec.ts:7:1

# Error details

```
Error: E2E：等待 /web URL 超时（/var/folders/9m/14r3v7xd2llf3sbqh9r622yr0000gn/T/za38-e2e-cli-q9OamZ/url.txt）
```
