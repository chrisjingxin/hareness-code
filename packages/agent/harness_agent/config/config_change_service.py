...
from harness_agent.config.config import DEFAULT_MODEL_CAPABILITIES, ConfigError, Za38Config, load_config

if TYPE_CHECKING:
    from harness_agent.extensions.mcp import McpConfigSnapshot, McpServerConfig
...
class ConfigChangeService:
    ...
    def add_mcp_server(
        ...
        *,
        ...
        """
        from harness_agent.extensions.mcp import McpConfigError, McpServerConfig, build_mcp_snapshot, parse_mcp_config
    ...
    def remove_mcp_server(
        ...
        *,
        ...
        from harness_agent.extensions.mcp import build_mcp_snapshot, parse_mcp_config
