...
PROTOCOL_MAJOR = 3
PROTOCOL_MINOR = 9
PROTOCOL_SCHEMA_SHA256 = "e8380ead4ae1ab49202f2989bfa10a1728b191156ea463cd1a049d5a42b66efc"
...
NOTIFICATION_METHODS = ["thread.summary"]
...
OPERATION_MIN_MINOR = {"commands.bind":6,"settings.list":8,"settings.set":8,"settings.remove":8,"threads.set_title":9,"skills.list":8,"plugins.list":8,"plugins.inspect":8,"plugins.validate":8,"plugins.install":8,"plugins.update":8,"plugins.set_enabled":8,"plugins.remove":8,"agents.list":8,"mcp.status":8,"goal.inspect":8,"goal.request":8,"goal.mutate":8}
