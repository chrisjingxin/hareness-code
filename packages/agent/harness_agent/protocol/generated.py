...
PROTOCOL_MAJOR = 3
PROTOCOL_MINOR = 4
PROTOCOL_SCHEMA_SHA256 = "9315edcba1f681beb96bd537d1d2b513e3bc6897623fca6fadf373727bfa5dbf"
...
EVENT_TYPES = ["run.started","run.progress","skill.loaded","content.delta","reasoning.delta","tool.started","tool.delta","tool.completed","context.updated","compose.state","compose.summary","interaction.resolved","run.completed","run.cancelled","run.failed"]
