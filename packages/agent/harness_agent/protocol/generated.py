...
PROTOCOL_MAJOR = 3
PROTOCOL_MINOR = 2
PROTOCOL_SCHEMA_SHA256 = "41df1a3ec501134b285b36d9e3c10ba3ff56f226e1ef01b08b2b6de61ce82340"
...
EVENT_TYPES = ["run.started","run.progress","skill.loaded","content.delta","reasoning.summary","tool.started","tool.delta","tool.completed","context.updated","interaction.resolved","run.completed","run.cancelled","run.failed"]
...
class ReasoningSummaryPayloadWire(TypedDict):
    text: str
