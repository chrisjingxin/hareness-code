...
PROTOCOL_MAJOR = 3
PROTOCOL_MINOR = 2
PROTOCOL_SCHEMA_SHA256 = "9ba1bd73466e15f91d92f14ab3d0d31ade69de65af3d27b8f0790d16df55f359"
...
EVENT_TYPES = ["run.started","run.progress","skill.loaded","content.delta","tool.started","tool.delta","tool.completed","context.updated","interaction.resolved","run.completed","run.cancelled","run.failed"]
