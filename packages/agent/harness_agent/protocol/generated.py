...
PROTOCOL_MAJOR = 3
PROTOCOL_MINOR = 4
PROTOCOL_SCHEMA_SHA256 = "f3cf83078a8e5c86e8a46c0b620454cb6980ee359c4a270c51c2a082e5d3c9d4"
...
EVENT_TYPES = ["run.started","run.progress","skill.loaded","content.delta","reasoning.delta","tool.started","tool.delta","tool.completed","context.updated","compose.state","interaction.resolved","run.completed","run.cancelled","run.failed"]
