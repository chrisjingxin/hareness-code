...
test_evidence: -
references: docs/developer/tasks/ZC-124.md、docs/developer/tasks/ZC-125.md、docs/developer/tasks/ZC-126.md
completed_at: -
---
...
分组规则、降级行为和视觉层级以 [ZC-124 设计](../designs/ZC-124.md) 为准。
...
- 不实现 virtualization（ZC-130 根据测量决定）。
- 不调整 Composer/审批表单。
...
- 2026-08-09（Codex）：从 ZC-124 拆解；等待 ZC-125/ZC-126 稳定结构，下一次复核 2026-08-23。
