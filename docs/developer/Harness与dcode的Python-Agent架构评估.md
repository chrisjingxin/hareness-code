...
- [H-Architecture]：[架构总览](架构总览.md)
- [H-Refactor]：[架构重构计划](架构重构计划.md)
- [H-Task-085]：[ZC-085 清理未接线框架](tasks/ZC-085.md)
- [H-Task-086]：[ZC-086 提取模型绑定领域服务](tasks/ZC-086.md)
...
- [H-Approval]：[`harness_agent/approval_policy.py`](../../packages/agent/harness_agent/approval_policy.py)
- [H-Concurrency]：[`harness_agent/concurrency_guard.py`](../../packages/agent/harness_agent/concurrency_guard.py)
- [H-MCP]：[`harness_agent/mcp.py`](../../packages/agent/harness_agent/mcp.py)
...
[H-Architecture]: 架构总览.md
[H-Refactor]: 架构重构计划.md
[H-Task-085]: tasks/ZC-085.md
[H-Task-086]: tasks/ZC-086.md
...
[H-Approval]: ../../packages/agent/harness_agent/approval_policy.py
[H-Concurrency]: ../../packages/agent/harness_agent/concurrency_guard.py
[H-MCP]: ../../packages/agent/harness_agent/mcp.py
