# HC-157-legacy 修复 Web 刷新回退 Todo

关联 [Task](../task/archive/HC-157-legacy-修复Web刷新回退.md)、[Spec](../spec/HC-157-legacy-修复Web刷新回退.md) 与 [Plan](../plan/HC-157-legacy-修复Web刷新回退.md)。
