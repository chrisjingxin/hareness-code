...
- dcode：本地源码库，`deepagents-code 0.1.65`（`libs/code/pyproject.toml:5-8`），commit `03436b369c0324498602fe6b7918cf36f3629d76`；工作区只有未跟踪的 `.codex/`，未参与判断。
...
- dcode 证据：本地源码库，特别是 `:2566-2640` 与 `:2687-2689`。
