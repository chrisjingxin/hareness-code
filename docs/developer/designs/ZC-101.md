...
原始需求：[ZC-101](../tasks/archive/ZC-101-legacy.md)  
...
- 后续执行 Thread 必须同时读取[原始需求](../tasks/archive/ZC-101-legacy.md)与本方案，并保留当前工作区中 Web launcher/tests 的用户改动，不将它们纳入 ZC-101。
